...
class MainActivity : ComponentActivity() {
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val name = "Ecommerce Notifications"
            val descriptionText = "Notifications for sales and updates"
            val importance = NotificationManager.IMPORTANCE_DEFAULT
            val channel = NotificationChannel("ecommerce_channel", name, importance).apply {
    ...
    private fun sendDemoNotification() {
        val builder = NotificationCompat.Builder(this, "ecommerce_channel")
            .setSmallIcon(android.R.drawable.ic_dialog_info)
            .setContentTitle("Welcome to Flux Store!")
            .setContentText("Check out our latest summer collection!")
